...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/udp-server.new.c</source>
      <commands EXPORT="discard">make udp-server.new.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/udp-server.new.sky</firmware>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONFIG_DIR]/udp-client.new.c</source>
      <commands EXPORT="discard">make udp-client.new.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONFIG_DIR]/udp-client.new.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
