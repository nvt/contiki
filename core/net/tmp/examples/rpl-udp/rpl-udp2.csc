...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>54.166831110167784</x>
        <y>14.013544721600004</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>37.36294844219791</x>
        <y>43.79290084168809</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>66.25528173019661</x>
        <y>46.682134170487956</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>94.32211978139534</x>
        <y>39.66542465768828</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>33.64821987659808</x>
        <y>73.92347698488673</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>96.38585787339524</x>
        <y>71.85973889288682</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.4645869200733457 0.0 0.0 3.4645869200733457 -52.86718246821359 -19.08431144818155</viewport>
    </plugin_config>
    <width>351</width>
    <z>3</z>
    <height>349</height>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <showLEDs />
      <split>-1</split>
      <zoomfactor>4743.867918179263</zoomfactor>
    </plugin_config>
    <width>1858</width>
    <z>2</z>
    <height>239</height>
